...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/linhay/libghostty/releases/download/storage.1.0.1776673833/GhosttyKit.xcframework.zip",
            checksum: "c36afe1059c7035ed4559473ccca1617181d7a423b2af14d66853844f594e96f"
        ),
        .testTarget(
            name: "GhosttyKitTest",

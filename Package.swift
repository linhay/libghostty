...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/linhay/libghostty/releases/download/storage.1.0.1779706534/GhosttyKit.xcframework.zip",
            checksum: "aca8cc8e40e286acd06bfe116d5d14a213179fae7b49675ecd986090fa3bac00"
        ),
        .testTarget(
            name: "GhosttyKitTest",

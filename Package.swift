...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/linhay/libghostty/releases/download/storage.1.0.1787556963/GhosttyKit.xcframework.zip",
            checksum: "d935898b30ea55446620edc5b74b24ac3b4faa2e548d26929f9120f669ff0ff4"
        ),
        .testTarget(
            name: "GhosttyKitTest",

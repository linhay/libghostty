...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/linhay/libghostty/releases/download/storage.1.0.1788785443/GhosttyKit.xcframework.zip",
            checksum: "84bb06351ffd03c7f216380191102079577c88cfeb72edfb273164d5c48d7a43"
        ),
        .testTarget(
            name: "GhosttyKitTest",

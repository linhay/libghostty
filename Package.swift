...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/linhay/libghostty/releases/download/storage.1.0.1785147151/GhosttyKit.xcframework.zip",
            checksum: "e8dec0ada30fe645dc365fd7d60a1db990090d1571f34f6b97571c0e83a5c580"
        ),
        .testTarget(
            name: "GhosttyKitTest",

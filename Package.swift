...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/linhay/libghostty/releases/download/storage.1.0.1778493938/GhosttyKit.xcframework.zip",
            checksum: "4e82761a0ffe3891fa26f2e8499ea16e4276d639da1b83948107818008311fad"
        ),
        .testTarget(
            name: "GhosttyKitTest",

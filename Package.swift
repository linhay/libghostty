...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/linhay/libghostty/releases/download/storage.1.0.1783936244/GhosttyKit.xcframework.zip",
            checksum: "1539ab15a7f368d6701af2ce596033ea5574fd9f88a5c8c764a74ae34cd390c6"
        ),
        .testTarget(
            name: "GhosttyKitTest",

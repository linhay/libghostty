...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/linhay/libghostty/releases/download/storage.1.0.1780917755/GhosttyKit.xcframework.zip",
            checksum: "6867c92767276748e1456ed556bb253b3915732e86fff289b1ff3c053486331b"
        ),
        .testTarget(
            name: "GhosttyKitTest",

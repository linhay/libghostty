...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/linhay/libghostty/releases/download/storage.1.0.1783336237/GhosttyKit.xcframework.zip",
            checksum: "02c301666127b8b8c40d3ef26d1a0a346f8f443e322aaf71bca045e7e79fb725"
        ),
        .testTarget(
            name: "GhosttyKitTest",

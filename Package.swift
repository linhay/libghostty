...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/linhay/libghostty/releases/download/storage.1.0.1785751946/GhosttyKit.xcframework.zip",
            checksum: "a79b5281d658dfc5012436422b92eaaeb86b10a67a31265b0db9a420a2cbd86a"
        ),
        .testTarget(
            name: "GhosttyKitTest",

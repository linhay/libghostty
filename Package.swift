...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/linhay/libghostty/releases/download/storage.1.0.1789995918/GhosttyKit.xcframework.zip",
            checksum: "a4454bfe40bd53b0e2be44b450e3600b6062b5fb244d3ba1e811b525cd3e7f1f"
        ),
        .testTarget(
            name: "GhosttyKitTest",

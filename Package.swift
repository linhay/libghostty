...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/linhay/libghostty/releases/download/storage.1.0.1788185465/GhosttyKit.xcframework.zip",
            checksum: "3748054c873566cca689ac117e87711c8336f524199ff1556549aaad83ba4da6"
        ),
        .testTarget(
            name: "GhosttyKitTest",

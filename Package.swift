...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/linhay/libghostty/releases/download/storage.1.0.1780316118/GhosttyKit.xcframework.zip",
            checksum: "804074dd3a5dcb28a5639e650bebe4c7bcaa3ec0f2c7ccf52ed12f5a625f02cd"
        ),
        .testTarget(
            name: "GhosttyKitTest",
